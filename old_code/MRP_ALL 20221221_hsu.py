...
def data_gen(T, product_size, item_size):
	...
	# item_size: size of component types
 	 ...
 	 # bom = np.array([[1,1,1],[0,0,0],[1,1,0],[1,0,0]])
 	  ...
 	  demand = np.random.randint(0, 200, size=(T, product_size)) # (time by product array) demand @ t 
...
# 	time.clock = time.time
	...
	case_param = [(52, 10, 500)] #, (10, 10, 6),(15, 6, 70)] # (T, product_size, item_size)
	count = 1
...
#---------------------------------------------------
		...
		print("MRP, vs. naive_evaluator:")
		assert_frame_equal(df_backlog2, df_backlog3, check_dtype=False)
        
        
#---------------------------------------------------        
		total_backlog_qty = total_backlog(arrival, demand, bom)
		print("df_ans1, vs. total_backlog_qty:")
		assert_frame_equal(df_ans1, total_backlog_qty, check_dtype=False)
...
# arrival_test = arrival.tolist()
# demand_test = demand.tolist()
# bom_test = bom.tolist()
# print(arrival_test)
# print(demand_test)
# print(bom_test)
