...
def gsha_fun(T, product_size, item_size, bom, MaxIteration, pop_size, upper_bound, initial_fit, initial_sol, ga_check_count=1000, spsa_check_count=2000):
    ...
    while measurement_count < MaxIteration:
        ...
        if flag == 1:
            ga_best_fitnes, ga_fitness_list, ga_best_sol, ga_measurment = ga_fun(T, product_size, item_size, bom, MaxIteration, pop_size, upper_bound, initial_fit, initial_sol, measurement_count, ga_check_count)
            ...
            spsa_best_fitnes, spsa_fitness_list, spsa_best_sol, spsa_measurment = spsa_fun(T, product_size, item_size, bom, MaxIteration, upper_bound, initial_fit, initial_sol, measurement_count, spsa_check_count)
