...
def data_gen(T, product_size, item_size, lam = 50):
	# T: time frame
	...
	#  ---------- Case 1 -------------
	demand = np.ones((T, product_size))*lam
	bom = np.ones((product_size, item_size))
...
'''if __name__ == '__main__' :
	...
	for c in case_param:
		...
		arrival = np.ones((T, item_size))*product_size*1000
